!function (e, t) {
    ...
    var t = "SweetAlert2:", p = function (e) {
        ...
        Y = function (e) {
            ...
            if (t && (t.parentNode.removeChild(t), U([document.documentElement, document.body], [I["no-backdrop"], I["toast-shown"], I["has-column"]])), !O()) {
                ...
                o.appendChild(n);
                var i, r = y(), a = k(), s = _(a, I.input), c = _(a, I.file),
            ...
            if (!e) return W(t);
            if (e instanceof HTMLElement) t.appendChild(e); else if ("object" === V(e)) if (t.innerHTML = "", 0 in e) for (var n = 0; n in e; n++) t.appendChild(e[n].cloneNode(!0)); else t.appendChild(e.cloneNode(!0)); else e && (t.innerHTML = e);
            z(t)
        }, J = function () {
            if (O()) return !1;
            ...
            var r = x(), a = parseInt(null === i.currentProgressStep ? Pe.getQueueStep() : i.currentProgressStep, 10);
    ...
    var ie = [], re = function () {
        ...
        }), fe = {promise: new WeakMap, innerParams: new WeakMap, domCache: new WeakMap};
    ...
    function ye(e) {
        var t = v(), n = y(), o = fe.innerParams.get(this), i = be.swalPromiseResolve.get(this), r = o.onClose,
            a = o.onAfterClose;
        if (n) {
    ...
    var xe, Ae = Object.freeze({
        hideLoading: me, disableLoading: me, getInput: function (e) {
            ...
            var t = s({}, fe.innerParams.get(this), {progressSteps: e});
            ...
            !function (t) {
                ...
                var n = y(), o = "string" == typeof t.target ? document.querySelector(t.target) : t.target;
            ...
            return new Promise(function (e) {
                var n = function (e) {
                    E.closePopup({value: e})
                }, s = function (e) {
                    E.closePopup({dismiss: e})
                };
                ...
                for (var c = function (t) {
                    T.showLoaderOnConfirm && M.showLoading(), T.preConfirm ? (E.resetValidationMessage(), Promise.resolve().then(function () {
                        ...
                        K(O.validationMessage) || !1 === e ? E.hideLoading() : n(e || t)
                    })) : n(t)
                }, t = function (e) {
                    var t = e.target, n = O.confirmButton, o = O.cancelButton, i = n && (n === t || n.contains(t)),
                        r = o && (o === t || o.contains(t));
                    switch (e.type) {
                        case"click":
                            if (i && M.isVisible()) if (E.disableButtons(), T.input) {
                                var a = function () {
                                    var e = E.getInput();
                                    if (!e) return null;
                                    switch (T.input) {
                            ...
                            } else c(!0); else r && M.isVisible() && (E.disableButtons(), s(M.DismissReason.cancel))
                    }
                ...
                ae.keydownHandlerAdded && (ae.keydownTarget.removeEventListener("keydown", ae.keydownHandler, {capture: ae.keydownListenerCapture}), ae.keydownHandlerAdded = !1), T.toast || (ae.keydownHandler = function (e) {
                    return function (e, t) {
                        if (t.stopKeydownPropagation && e.stopPropagation(), "Enter" !== e.key || e.isComposing) if ("Tab" === e.key) {
                            for (var n = e.target, o = Q(t.focusCancel), i = -1, r = 0; r < o.length; r++) if (n === o[r]) {
                                i = r;
                                break
                            }
                ...
                switch (T.input) {
                    ...
                    case"radio":
                        ...
                        break;
                    case"checkbox":
                        var A = _(O.content, I.checkbox), S = E.getInput("checkbox");
